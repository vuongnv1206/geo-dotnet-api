...
namespace Migrators.PostgreSQL.Migrations.Application
{
    ...
    [Migration("20240822142730_submitPaperLogSusRea")]
    partial class submitPaperLogSusRea
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FSH.WebApi.Domain.Examination.PaperMatrix", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PaperMatrices", "Examination");
            ...
            modelBuilder.Entity("FSH.WebApi.Domain.Examination.SubmitPaperLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("CommonLog")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("MouseLog")
                        .HasColumnType("text");

                    b.Property<string>("NetworkLog")
                        .HasColumnType("text");
                    ...
                    b.ToTable("SubmitPaperLogs", "Examination");
            ...
            modelBuilder.Entity("FSH.WebApi.Domain.Payment.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Orders", "Payment");

                    b.HasAnnotation("Finbuckle:MultiTenant", true);
                });

            modelBuilder.Entity("FSH.WebApi.Domain.Payment.Subscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Subscriptions", "Payment");

                    b.HasAnnotation("Finbuckle:MultiTenant", true);
                });

            modelBuilder.Entity("FSH.WebApi.Domain.Payment.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.WebApi.Domain.TeacherGroup.InviteJoinTeacherTeam", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("InviteJoinTeacherTeam", "GroupTeacher");

                    b.HasAnnotation("Finbuckle:MultiTenant", true);
                });

            modelBuilder.Entity("FSH.WebApi.Domain.TeacherGroup.JoinGroupTeacherRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("JoinGroupTeacherRequest", "GroupTeacher");

                    b.HasAnnotation("Finbuckle:MultiTenant", true);
                });

            modelBuilder.Entity("FSH.WebApi.Domain.TeacherGroup.JoinTeacherTeamRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("AdminTeamId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("JoinTeacherTeamRequest", "GroupTeacher");
            ...
            modelBuilder.Entity("FSH.WebApi.Domain.Payment.Order", b =>
                {
                    b.HasOne("FSH.WebApi.Domain.Payment.Subscription", "Subscription")
                        .WithMany()
