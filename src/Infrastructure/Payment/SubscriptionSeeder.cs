...
public class SubscriptionSeeder : ICustomSeeder
{
    ...
    public async Task InitializeAsync(CancellationToken cancellationToken)
    {
        if (!_db.Subscriptions.Any())
        {
            ...
            {
                new Subscription { Name = FSHRoles.Basic, Role = FSHRoles.Basic, Duration = 6, Price = 1000, Image = "<i class=\"fa-regular fa-user\"></i>", Description = "The Basic Subscription offers essential features to get started with our education system. This tier is perfect for individual learners or small groups who need access to core learning materials and tools."},
                new Subscription { Name = FSHRoles.Standard, Role = FSHRoles.Standard, Duration = 12, Price = 5000, Image = "<i class=\"fa-regular fa-user\"></i>", Description = "The Standard Subscription provides an enhanced learning experience with additional resources and support. This tier is ideal for students and educators who require more comprehensive tools and materials to facilitate effective learning and teaching." },
                new Subscription { Name = FSHRoles.Professional, Role = FSHRoles.Professional, Duration = 24, Price = 10000, Image = "<i class=\"fa-regular fa-user\"></i>", Description = "The Professional Subscription offers the most extensive and immersive educational experience. This tier is designed for institutions, professional educators, and serious learners who need a full suite of tools and resources to achieve their educational goals." }
                };
