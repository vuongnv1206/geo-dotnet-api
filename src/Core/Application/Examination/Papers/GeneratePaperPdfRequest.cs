...
public class GeneratePaperPdfRequestHandler : IRequestHandler<GeneratePaperPdfRequest, byte[]>
{
    ...
    public byte[] Handle(GeneratePaperPdfRequest request, CancellationToken cancellationToken)
    {
    ...
    Task<byte[]> IRequestHandler<GeneratePaperPdfRequest, byte[]>.Handle(GeneratePaperPdfRequest request, CancellationToken cancellationToken)
    {
